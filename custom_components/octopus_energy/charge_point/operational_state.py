...
# ChargePointOperationalState enum, confirmed via live GraphQL introspection
operational_state_options = [
  "CHARGING",
  "BOOST_CHARGING",
  "NOT_CHARGING",
  "UNPLUGGED",
...
class OctopusEnergyChargePointOperationalState(CoordinatorEntity, BaseOctopusEnergyChargePointSensor, RestoreSensor):
  ...
  def unique_id(self):
    ...
    return f"octopus_energy_charge_point_{self._charge_point_id}_operational_state"

  @property
  def name(self):
    """Name of the sensor."""
    return f"Operational State Charge Point ({self._charge_point_id})"
  ...
  def options(self):
    ...
    return operational_state_options
  ...
  def _handle_coordinator_update(self) -> None:
    """Retrieve the operational state for the charge point."""
    current = now()
  ...
  async def async_added_to_hass(self):
    ...
    if state is not None and last_sensor_state is not None and self._state is None:
      ...
      _LOGGER.debug(f'Restored OctopusEnergyChargePointOperationalState state: {self._state}')
