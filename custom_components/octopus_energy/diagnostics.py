...
async def async_get_diagnostics(client: OctopusEnergyApiClient, account_id: str, account_info, account_debug_override: AccountDebugOverride | None, get_entity_info: Callable[[dict], dict]):
