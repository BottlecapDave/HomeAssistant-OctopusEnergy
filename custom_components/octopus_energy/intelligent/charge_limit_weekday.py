...
class OctopusEnergyIntelligentChargeLimitWeekday(CoordinatorEntity, RestoreNumber, OctopusEnergyIntelligentSensor):
  """Sensor for setting the target percentage for car charging on weekdays."""
  ...
  def unique_id(self):
    ...
    return f"octopus_energy_intelligent_charge_limit_weekday"
    
  @property
  def name(self):
    """Name of the sensor."""
    return f"Octopus Energy Intelligent Charge Limit Weekday"
  ...
  def native_value(self) -> float:
    ...
    return self.coordinator.data["charge_limit_weekday"]
