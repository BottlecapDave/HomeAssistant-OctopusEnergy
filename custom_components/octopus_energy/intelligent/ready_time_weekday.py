...
class OctopusEnergyIntelligentReadyTimeWeekday(CoordinatorEntity, TimeEntity, OctopusEnergyIntelligentSensor):
  """Sensor for setting the target time to charge the car to the desired percentage on weekdays."""
  ...
  def unique_id(self):
    ...
    return f"octopus_energy_intelligent_ready_time_weekday"
    
  @property
  def name(self):
    """Name of the sensor."""
    return f"Octopus Energy Intelligent Ready Time Weekdays"
