    ...
    for point in account_info["gas_meter_points"]:
      ...
      if gas_tariff_code != None:
        for meter in point["meters"]:
          ...
          if meter["is_smart_meter"] == True:
            coordinator = create_reading_coordinator(hass, client, False, meter, point)
            entities.append(OctopusEnergyPreviousAccumulativeGasConsumption(coordinator, meter, point, meter["consumption_units"], calorific_value))
            entities.append(OctopusEnergyPreviousAccumulativeGasConsumptionKwh(coordinator, meter, point, meter["consumption_units"], calorific_value))
            entities.append(OctopusEnergyPreviousAccumulativeGasCost(coordinator, client, gas_tariff_code, meter, point, meter["consumption_units"], calorific_value))
