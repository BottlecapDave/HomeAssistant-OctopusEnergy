      ...
      if electricity_tariff is not None:
        for meter in point["meters"]:
          ...
          if meter["is_smart_meter"] == True:
            entities.append(OctopusEnergyPreviousAccumulativeElectricityCostTariffOverride(hass, account_id, client, electricity_tariff.code, meter, point))
      else:
        for meter in point["meters"]:
    ...
    for point in account_info["gas_meter_points"]:
      ...
      if gas_tariff is not None:
        for meter in point["meters"]:
          ...
          if meter["is_smart_meter"] == True:
            entities.append(OctopusEnergyPreviousAccumulativeGasCostTariffOverride(hass, account_id, client, gas_tariff.code, meter, point))
      else:
        for meter in point["meters"]:
