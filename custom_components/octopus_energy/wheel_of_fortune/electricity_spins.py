...
class OctopusEnergyWheelOfFortuneElectricitySpins(MultiCoordinatorEntity, RestoreSensor):
  ...
  async def async_spin_wheel(self):
    ...
    result = await self._client.async_spin_wheel_of_fortune(self._account_id, True, is_octoplus_enrolled)
    return {
