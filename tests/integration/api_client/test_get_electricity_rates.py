...
@pytest.mark.parametrize("product_code,tariff_code,price_cap,period_from,period_to",[
    ...
    ("SILVER-23-12-06", "E-FLAT2R-SILVER-23-12-06-A", None, datetime.strptime("2023-07-01T00:00:00+01:00", "%Y-%m-%dT%H:%M:%S%z"), datetime.strptime("2023-07-04T00:00:00+01:00", "%Y-%m-%dT%H:%M:%S%z")),
    ...
    ("SILVER-23-12-06", "E-FLAT2R-SILVER-23-12-06-A", 10, datetime.strptime("2023-07-01T00:00:00+01:00", "%Y-%m-%dT%H:%M:%S%z"),  datetime.strptime("2023-07-04T00:00:00+01:00", "%Y-%m-%dT%H:%M:%S%z")),
])
