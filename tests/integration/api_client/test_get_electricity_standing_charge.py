...
@pytest.mark.parametrize("product_code,tariff_code,expected_value_inc_vat,favour_direct_debit",[
    ("SUPER-GREEN-24M-21-07-30", "E-1R-SUPER-GREEN-24M-21-07-30-A", 24.0135, True),
    ("SUPER-GREEN-24M-21-07-30", "E-1R-SUPER-GREEN-24M-21-07-30-A", 24.0135, False),
    ("GO-18-06-12", "E-1R-GO-18-06-12-A", 25.0005, True),
...
@pytest.mark.parametrize("product_code,tariff_code,favour_direct_debit",
                         [("SILVER-FLEX-22-11-25", "E-1R-SILVER-FLEX-22-11-25-C", True),
                          ("SILVER-FLEX-22-11-25", "E-1R-SILVER-FLEX-22-11-25-C", False)])
