...
async def test_when_account_info_is_none_then_existing_rates_returned():
  ...
  dispatches_result = { "1": IntelligentDispatchesCoordinatorResult(dispatches_last_retrieved, 1, IntelligentDispatches("SMART_CONTROL_IN_PROGRESS", [], []), 1, dispatches_last_retrieved) }
...
@pytest.mark.parametrize("dispatches_result",[
  (None),
  (IntelligentDispatchesCoordinatorResult(dispatches_last_retrieved, 1, None, 1, dispatches_last_retrieved)),
  (IntelligentDispatchesCoordinatorResult(dispatches_last_retrieved, 1, IntelligentDispatches("SMART_CONTROL_IN_PROGRESS", None, []), 1, dispatches_last_retrieved)),
  (IntelligentDispatchesCoordinatorResult(dispatches_last_retrieved, 1, IntelligentDispatches("SMART_CONTROL_IN_PROGRESS", [], None), 1, dispatches_last_retrieved)),
])
