...
def test_when_get_applicable_dispatch_periods_called_with_no_planned_dispatches_then_it_returns_empty_list():
  # Arrange
...
def test_when_get_applicable_dispatch_periods_called_with_no_started_dispatches_and_mode_is_started_only_then_it_returns_empty_list():
  # Arrange
  planned_dispatches = [
...
def test_when_get_applicable_dispatch_periods_called_with_started_dispatches_then_it_returns_them():
  # Arrange
  planned_dispatches = None
  started_dispatches = [
...
def test_when_get_applicable_dispatch_periods_called_with_planned_and_started_mode_and_non_smart_charge_dispatch_then_it_excludes_planned_dispatch():
  # Arrange
  planned_dispatches = [
    IntelligentDispatchItem(
      start=now,
...
def test_when_get_applicable_dispatch_periods_called_with_planned_and_started_only_mode_and_smart_charge_dispatch_then_it_includes_planned_dispatch():
  # Arrange
  planned_dispatches = [
    IntelligentDispatchItem(
      start=now,
...
def test_when_get_applicable_dispatch_periods_called_with_overlapping_dispatches_then_it_merges_them():
  # Arrange
  started_dispatches = [
    SimpleIntelligentDispatchItem(
      start=now,
...
def test_when_get_applicable_dispatch_periods_called_with_adjacent_dispatches_then_it_merges_them():
  # Arrange
  started_dispatches = [
    SimpleIntelligentDispatchItem(
      start=now,
...
def test_when_get_applicable_dispatch_periods_called_with_multiple_dispatches_then_it_sorts_them_by_start_time():
  # Arrange
  started_dispatches = [
    SimpleIntelligentDispatchItem(
...
def test_when_get_applicable_dispatch_periods_called_with_both_planned_and_started_then_it_combines_them_correctly():
  # Arrange
  planned_dispatches = [
    IntelligentDispatchItem(
      start=now,
...
def test_when_get_applicable_dispatch_periods_called_with_source_none_then_it_is_included():
  # Arrange
  planned_dispatches = [
    IntelligentDispatchItem(
      start=now,
...
def test_when_get_applicable_dispatch_periods_called_with_source_none_and_below_minimum_dispatch_in_minutes_then_it_is_not_included():
  # Arrange
  minimum_dispatch_in_minutes = 3
  planned_dispatches = [
    IntelligentDispatchItem(
      start=now,
      end=now + timedelta(minutes=1, seconds=59),
      charge_in_kwh=1.0,
      source=None,
      location="location"
    ),
  ...
  # Act
  result = get_applicable_dispatch_periods(planned_dispatches, started_dispatches, mode, minimum_dispatch_in_minutes)
